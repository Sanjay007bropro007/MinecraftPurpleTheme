...
installTheme(){
    ...
    git clone https://github.com/Sanjay007bropro007/MinecraftPurpleTheme.git
...
repair(){
    bash <(curl https://raw.githubusercontent.com/Sanjay007bropro007/MinecraftPurpleTheme/main/repair.sh)
}
